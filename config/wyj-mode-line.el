...
(defun wyj/mode-line:current-height ()
...
(defun wyj/defun-bicolor-face (face fg-color bg-color)
    (make-face face)
    (set-face-attribute face nil
                        :foreground fg-color
                        :background bg-color))

(defun wyj/defun-bicolor-transition-face (face bicolor-face-from bicolor-face-to)
  (wyj/defun-bicolor-face face
                           (face-attribute bicolor-face-from :background)
                           (face-attribute bicolor-face-to :background)))
  
    

(defun wyj/bicolor-face-attribute (face)
  (list
   (face-attribute face :foreground)
   (face-attribute face :background)))

(defun wyj/mode-line:data-generator-left-triangle (height width)
...
(defun wyj/mode-line:data-generator-eight-trigrams (height width)
  (list "..............      "
        "............        "
        ".........           "
        ".......             "
...
(defun wyj/create-bicolor-xpm (height width fg-color bg-color data-generator)
...
(defun wyj/create-bicolor-xpm-from-face (height width bicolor-face data-generator)
  (apply #'wyj/create-bicolor-xpm
         (append 
          (list height width)
          (wyj/bicolor-face-attribute bicolor-face)
          (list data-generator))))


(defun wyj/mode-line:create-left-triangle-xpm (bicolor-face &optional width)
...
and BG-COLOR to be the background color"
  (let* ((height (wyj/mode-line:current-height))
         (width (or width height)))
    (wyj/create-bicolor-xpm-from-face height
                                       width
                                       bicolor-face
                                       #'wyj/mode-line:data-generator-left-triangle)))

(defun wyj/mode-line:create-eight-trigrams-xpm (bicolor-face)
  (let ((height (wyj/mode-line:current-height)))
    (wyj/create-bicolor-xpm-from-face height
                                       height
                                       bicolor-face
                                       #'wyj/mode-line:data-generator-eight-trigrams)))


(defun wyj/mode-line:decorate-string-face (mode-line-var bicolor-face)
...
(wyj/defun-bicolor-face 'mode-line-face/encoding-writable-modified "#000000" "#999999")
(wyj/defun-bicolor-face 'mode-line-face/buffer-name "#FFFFFF" "#555555")
(wyj/defun-bicolor-transition-face 'mode-line-face/transition1
                                    'mode-line-face/encoding-writable-modified
                                    'mode-line-face/buffer-name)
(wyj/defun-bicolor-transition-face 'mode-line-face/transition2
                                    'mode-line-face/buffer-name
                                    'mode-line)

(defun wyj/mode-line:create-triangle-seperator (face)
  (propertize " "
              'display
              (wyj/mode-line:create-left-triangle-xpm face)))

(defun wyj/mode-line:create-eight-trigrams-seperator (face)
  (propertize " "
              'display
              (wyj/mode-line:create-eight-trigrams-xpm face)))
...
(setq-default mode-line-format
              (list
               ...
               (wyj/mode-line:decorate-string-face mode-line-modified
                                                    'mode-line-face/encoding-writable-modified)
               (wyj/mode-line:create-eight-trigrams-seperator 'mode-line-face/transition1)
               ;mode-line-remote, remove
               ;mode-line-frame-identification, remove
               (wyj/mode-line:decorate-string-face mode-line-buffer-identification
                                                    'mode-line-face/buffer-name)
               (wyj/mode-line:create-triangle-seperator 'mode-line-face/transition2)
               mode-line-position
               '(vc-mode vc-mode)
               mode-line-modes
...
;(insert (wyj/mode-line:create-triangle-seperator 'mode-line-face/transition1))
;(wyj/create-bicolor-xpm 20 10 "#0A0A0A" "#A0A0A0" #'wyj/mode-line:data-generator-left-triangle)
;(wyj/create-bicolor-xpm-from-face 20 10 'mode-line-face/transition1
;                                   'wyj/mode-line:data-generator-left-triangle)

(provide 'wyj-mode-line)
